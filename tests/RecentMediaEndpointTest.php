...
class RecentMediaEndpointTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function responses()
    {
        return collect([
            'first' => collect([
                'url' => 'https://api.instagram.com/v1/users/self/media/recent?access_token=api-token&count=100',
                'data' => [
                    'pagination' => [
                        'next_url' => 'https://api.instagram.com/v1/users/self/media/recent?access_token=api-token&count=100&cursor=test-cursor',
            ...
            'second' => collect([
                'url' => 'https://api.instagram.com/v1/users/self/media/recent?access_token=api-token&count=100&cursor=test-cursor',
                'data' => [
                    'pagination' => [],
                    'meta' => ['code' => 200],
                    'data' => [
